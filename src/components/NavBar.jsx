...
import { LINKS } from "../constants/index"; // Adjust the path as necessary
        ...
        <>
            <nav className="border-b-2">
                ...
                <div className="max-w-7xl mx-auto flex justify-between items-center py-8">
                    ...
                    <div className={`${isOpen ? "block" : "hidden"} md:hidden absolute bg-neutral-50 w-full py-5 px-4 mt-2 border-b-4 top-16 left-0 z-50 `}>
                        {LINKS.map((link, index) => (
